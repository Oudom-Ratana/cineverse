      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-neutral-500 font-semibold mt-2">
            Manage your platform&apos;s content catalog ({movies.length} Real
            TMDB Titles Active — Synced with User Website).
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            ...
            <span>{isSyncing ? "Syncing TMDB..." : "Sync Live TMDB (15)"}</span>
          </button>
